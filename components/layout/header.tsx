    ...
    <header ref={headerRef} className="brutalist-header">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between py-4">
          {/* Logo */}
          <Link href="/" className="brutalist-logo z-20">
            NABEERA BAEERA
          </Link>
                ...
                <div className="flex flex-col h-full py-6">
                  ...
                  <nav className="flex flex-col space-y-4">
                    <Link
                      ...
                      className="text-lg font-medium py-2 hover:text-accent uppercase font-bold"
                    >
                      Jewelry
                    </Link>
                    <Link
                    ...
                    <Link href="/sale" className="text-lg font-medium py-2 hover:text-accent uppercase font-bold">
                      Sale
                    </Link>
                  </nav>
