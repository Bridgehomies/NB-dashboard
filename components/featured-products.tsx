        ...
        <div className="relative">
          <button
            ...
            className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-white p-2 hover:bg-primary hover:text-white transition-all
                      border-4 border-primary rotate-12 hover:rotate-0"
  ...
  return (
    <button
      ...
      className={`
        ...
        transform ${active ? "rotate-3" : "-rotate-3"} hover:rotate-0
        ${
          active
    ...
    >
      ...
      <div className="p-4 border-t-4 border-primary">
        ...
        <div className="flex items-center">
          {product.isSale ? (
            <>
              <span className="text-accent font-bold transform -rotate-3 inline-block">
