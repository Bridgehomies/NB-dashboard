...
export default function NewArrivalsPage() {
  ...
  return (
    <div className="min-h-screen pt-20 relative">
      ...
      {/* Hero Section */}
      <section className="relative h-[40vh] w-full overflow-hidden border-b-8 border-primary">
        <div className="absolute inset-0 bg-black/10 z-10" />
        <Image src="/placeholder.svg?height=800&width=1600" alt="New Arrivals" fill className="object-cover" priority />
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        {/* Newsletter Signup */}
        <div className="mt-16 brutalist-container bg-primary text-white transform rotate-1">
          <CircleDoodle className="absolute top-5 right-5 text-white opacity-30" />
          <h2 className="text-3xl font-bold mb-4 uppercase">Be the First to Know</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="newsletter-input flex-grow transform -rotate-1"
            />
            <AnimatedButton variant="white" animation="shake" iconPosition="right">
              Subscribe
            </AnimatedButton>
          </div>
        </div>
  ...
  return (
    <div className="brutalist-card transform-card group">
      <div className="relative h-[300px]">
        ...
        {/* Quick actions */}
        <div className="absolute bottom-0 left-0 right-0 bg-white border-t-4 border-primary p-2 flex justify-between opacity-0 group-hover:opacity-100 transition-opacity">
          <button className="p-2 border-2 border-primary hover-glitch transform hover:rotate-12">
            <Heart className="h-5 w-5" />
          </button>
          <button className="p-2 bg-primary text-white border-2 border-primary hover:bg-accent transform hover:-rotate-3">
      ...
      <div className="p-4 border-t-4 border-primary">
        ...
        <div className="flex justify-between items-center">
          <span className="font-bold transform rotate-3 inline-block">${product.price.toFixed(2)}</span>
